...
import * as discoveredActions from 'redux/modules/discovered';
import {isLoaded, load as loadWidgets} from 'redux/modules/discovered';
...
@connect(
  ...
  {...discoveredActions, initializeWithKey })
export default class Discovered extends Component {
  static propTypes = {
  ...
  render() {
    ...
    return (
      <div className={styles.widgets + ' container'}>
        ...
        <Helmet title="发现"/>
        <p>
          用户通过这个地方，按地区淘美食淘美景, the data loading will take place on the server before the page is returned.
